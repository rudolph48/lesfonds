  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <p className={styles.articleContent}>
        小小科普，Entremets字面上來看是法文「在兩道菜之間」（entre les mets）的意思，過去在筵席
      ...
      <p className={styles.articleContent}>
      這次的Entremets法式蛋糕 包含的法式甜點是夾層最簡單，也只需簡單裝飾即成的蛋糕，主要在
      ...
      <div className={styles.imageGallery}>
        <img src="/images/12.jpg" alt="Entremets ganache 1" className={styles.articleImage} />
        <img src="/images/13.jpg" alt="Entremets ganache 2" className={styles.articleImage} />
      </div>
    </div>
  );
};
